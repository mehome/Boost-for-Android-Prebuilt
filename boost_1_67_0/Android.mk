...
LOCAL_SRC_FILES := $(TARGET_ARCH_ABI)/lib/libboost_locale.a
include $(PREBUILT_STATIC_LIBRARY)
...
include $(CLEAR_VARS)
LOCAL_MODULE := libboost_stacktrace_addr2line
LOCAL_SRC_FILES := $(TARGET_ARCH_ABI)/lib/libboost_stacktrace_addr2line.a
include $(PREBUILT_STATIC_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE := libboost_stacktrace_backtrace
LOCAL_SRC_FILES := $(TARGET_ARCH_ABI)/lib/libboost_stacktrace_backtrace.a
include $(PREBUILT_STATIC_LIBRARY)
